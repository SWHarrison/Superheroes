...
def test_team_attack():
    ...
    assert team_two.heroes[0].health == 1000
...
def test_team_defend():
    ...
    deaths = team_one.defend([100,0])
    for hero in team_one.heroes:
        assert hero.health == 15

    assert deaths == 0

    assert team_one.defend([400,0]) == 20
