...
def test_hero_attack_ability():
    ...
    athena = superheroes.Hero("Athena")
    assert athena.attack() == [0,0]
    athena.add_ability(big_strength)
    attack = athena.attack()[1]
...
def test_team_remove_empty_list():
    team = superheroes.Team("One")
    assert team.remove_hero("Athena") == -999
...
def test_find_hero():
    ...
    jodie = superheroes.Hero("Jodie Foster")
    team.add_hero(jodie)
    hero = team.get_hero(team.find_hero("Jodie Foster"))
...
def test_find_unlisted_hero():
    ...
    jodie = superheroes.Hero("Jodie Foster")
    team.add_hero(jodie)
    assert team.find_hero("Alexa") == -999
